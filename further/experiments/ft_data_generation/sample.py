...
parser.add_argument(
    "--tokenized_dir", type=str, help="Target directory to save tokenized numpy"
)
parser.add_argument(
    "--target_dir", type=str, help="Target directory to save tokenized numpy"
)
parser.add_argument(
    "--eval_seq",
    type=int,
    default=2,
    help="How many sequences to sample for eval for each domain",
)
...
parser.add_argument(
    ...
    type=float,
    default=0.001,
    help="How many tokens (billion) sampled for pruning",
)
parser.add_argument(
    "--for_ft",
    type=float,
    default=0.001,
    help="How many tokens (billion) sampled for ft",
)
